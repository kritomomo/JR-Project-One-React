    ...
    render() {
        return (
            <div>
                ...
                <img alt={this.props.imgDesc} src={this.props.img} class="serviceItem__image" />
                </div>                     
                <h4 class="serviceItem__name">{this.props.title}</h4>
                <div class="serviceItem__description">{this.props.text}</div>
                </div>
            </div>
        );
    }
