...
const ServicesPage = () => (
    <div class="pt-page" data-id="services">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="service-block">
                        <div class="service-info">
                            <div class="service-image">
                                <img src="images/service/advertising_icon.png" alt="Advertising" class="mCS_img_loaded">
                            </div>
                            <h4>Advertising</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                        </div>
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="col-sm-4 col-md-2 subpage-block">
                        <div class="client-block">
                            <a href="#" target="_blank"><img src="images/clients/client_1.png" alt="image" class="mCS_img_loaded"></img>img</a>
                        </div>
                    </div>
